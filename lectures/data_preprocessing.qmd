...
4.	Determine which patients goes into the training, validation, calibration, and test set (using 70% training, 10% validation, 10% calibration, and 10% test). Add a variable indicating which set each observation belongs to.
