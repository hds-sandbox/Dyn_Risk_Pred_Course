...
# Data sources and biases """Maybe explain what retrospective - and prospective studies is JBKS"""

It is said that data scientists spend about 80% of their time preparing data for the actual modeling task. This 80/20 ratio varies, as some may use more time and others less. Regardless, there is a common knowledge that data management takes time. Data management does not only consist of handling missing values, transforming data, etc. Data sources, data collection, and managing data biases are also significant parts of data management and hence modeling as a whole.
In this section of the course, we will introduce data collection and the potential biases with regard to:
