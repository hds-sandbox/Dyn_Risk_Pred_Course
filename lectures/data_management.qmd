...
- DNPR (or LPR or PAS)
	- Only for patients in contact with the hospital
		- Informed presence bias
		- Issue with chronic conditions potentially treated by GPs
	- Administrative tool
		- The coding practices might be impacted by reimbursement
		- Not as thoroughly filled as a clinical tool
- Selection biases
	- Many more: sampling bias, susceptibility bias, confirmation bias, attrition bias, volunteer bias… (see
	  https://catalogofbias.org/biases/)
### Retrospective studies: coding and classification
- introduction for some of the data providers in Denmark
