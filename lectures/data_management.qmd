...
Data collection and management are crucial and often the most challenging parts of creating a predictive model.
There are usually obstacles in getting the data, which can take time and effort.
There can be problems meeting expectations about the data if it contains many missing values, or if the data format is different than anticipated.
Issues can arise when multiple datasets are gathered, as similar variables can have different measures, names can differ, and periods can vary (different degrees of granularity), etc.
...
These concepts will be covered in this section of the course where the main topics regarding data management are:
...
These distinctions are important for dynamic medicine prediction as their interplay is what gets the most out of the data. There is the raw data, where we need some information about the data to work with it (metadata), and the annotations provide more intuition about the meaning of the ranges in the data.
...
In the same vein as The Danish Health Data Authority, there are also institutions such as:
