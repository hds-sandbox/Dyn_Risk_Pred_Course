...
<div style="overflow: auto; text-align: center;">
  <img src="../images/table21.PNG" alt="Image" style="margin-bottom: 15px; width: 85%;">
</div>
...
A central Danish health data classification system is the Sundhedsvæsenet Klassifikationsystem (SKS), which is managed by [The Danish Health Data Authority](https://english.sundhedsdatastyrelsen.dk/health-data-and-registers/classifications). SKS is the national standard used throughout the Danish healthcare system.

The SKS uses the [World Health Organisation's International Classification of Diseases](International Classification of Diseases (ICD)), 10th Revision (ICD-10) for diagnostic data, thereby ensuring that Danish data is aligned with international standards.
...
Figure 1: SKS browser for code description. Screenshot from [medinfo.dk](medinfo.dk)
...
<div class="opt-list">
<div class="opt-btn" onclick="check(this, false, 'q-registry-bias', 'Incorrect. Registries are subject to data quality and completeness issues.')">a. All patients are always captured, so no bias is possible.
</div>
<div class="opt-btn" onclick="check(this, true, 'q-registry-bias', 'Correct! Frequent healthcare contacts lead to higher data density for sicker patients.')">b. Patients who are sicker may have more frequent healthcare contacts, leading to overrepresentation in the data.
</div>
<div class="opt-btn" onclick="check(this, false, 'q-registry-bias', 'Incorrect. Standardised systems like SKS reduce errors, but do not eliminate them.')">c. Registry data automatically eliminates all errors in diagnosis coding.
</div>
</div>
...
<div class="opt-list">
<div class="opt-btn" onclick="check(this, false, 'q-dnpr-identification', 'Incorrect. DNPR primarily focuses on hospital-level contacts.')">a. Yes, DNPR captures all type 2 diabetes diagnoses.
</div>
<div class="opt-btn" onclick="check(this, true, 'q-dnpr-identification', 'Correct! Type 2 diabetes is often managed in primary care, which DNPR (hospital-focused) does not fully cover.')">b. No, because type 2 diabetes is usually managed in general practice; only hospital-related cases appear in DNPR.</div>
<div class="opt-btn" onclick="check(this, false, 'q-dnpr-identification', 'Incorrect. This would still miss the vast majority of patients managed by GPs.')">c. Yes, but only if you include emergency admissions.
</div>
</div>
...
<div class="opt-list">
<div class="opt-btn" onclick="check(this, true, 'q-prescription-identification', 'Correct! Medications like Metformin can be used for multiple conditions (e.g., PCOS).')">a. Yes, but you must consider that some medications may be prescribed for other conditions.
</div>
<div class="opt-btn" onclick="check(this, false, 'q-prescription-identification', 'Incorrect. Prescriptions provide a proxy for diagnosis, even if not directly linked.')">b. No, prescriptions are not linked to diagnoses.
</div>
<div class="opt-btn" onclick="check(this, false, 'q-prescription-identification', 'Incorrect. Off-label use and multi-purpose drugs mean exceptions always exist.')">c. Yes, prescriptions perfectly identify type 2 diabetes without exceptions.
</div>
</div>
...
&nbsp;
 ...
 <p align="center">
  <a href="http://localhost:4707/lectures/data_preprocessing.html" style="background-color: #4266A1; color: #FFFFFF; padding: 30px 20px; text-decoration: none; border-radius: 5px;">
    Continue to
    Preprocessing
  </a>
</p>
