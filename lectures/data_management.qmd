...
[**Health Data Authority (SDS)**](https://english.sundhedsdatastyrelsen.dk/health-data-and-registers)

The Danish Health Data Authority (SDS) is one of the most comprehensive data holders within health data in Denmark. The SDS have a wide range of registries, as:

- Register of causes of death
- THe National Patient Register (LPR) (diagnoses, procedures...)
- Prescription register
- Pathology register
- MiBA database (with COVID data)
- THe Clinical Laboratory Information Register (LABKA)
- **Many more**
