...
<div class="opt-list">
<div class="opt-btn" onclick="check(this, true, 'q1', 'Correct!')">a. 30 days
</div>
<div class="opt-btn" onclick="check(this, false, 'q1', 'Incorrect.')">b. One year
</div>
</div>
