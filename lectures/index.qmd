...
- **Prediction time points $t_{ij}$:** for the $i$'th patient and the $j$'th time point: The specific moments at which predictions are made.
...
- **Time dependent data $Z_i(t)$ for patient $i$:** Measurements associated with the $i$'th patient that vary over time. Examples include weight, laboratory values, or medication prescriptions, recorded at various time points $t$.
...
- Date of diagnosis.
- The date of palliative treatment was initiated.
...
To continue to the next section of this course, please click on the button:
