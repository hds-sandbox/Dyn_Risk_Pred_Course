...
3. **Notebooks:** Notebooks and scripts can be downloaded here:

 &nbsp;

 <p align="center">
  <a href="https://github.com/hds-sandbox/Dyn_Risk_Pred_Course/tree/webpage-quarto/Notebooks" style="background-color: #4266A1; color: #FFFFFF; padding: 30px 20px; text-decoration: none; border-radius: 5px;">
    Download code
  </a>
</p>
...
### [Part 2 - Data Sources and Data Acquisition](lectures/data_management.qmd)
...
### [Part 3 - Data Preprocessing](lectures/data_preprocessing.qmd)
...
### [Part 4 - Modelling](lectures/modelling.qmd)
...
### [Part 5 - Implementation](lectures/implementation.qmd)
...
&nbsp;
 ...
 <p align="center">
  <a href="./lectures/data_management.qmd" style="background-color: #4266A1; color: #FFFFFF; padding: 30px 20px; text-decoration: none; border-radius: 5px;">
    Continue to
